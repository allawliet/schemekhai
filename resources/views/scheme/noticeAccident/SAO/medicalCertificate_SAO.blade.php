                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">HUS Recommendation Date IO </label>
                                                <input type="date" id="ioHus" name="ioHus"  class="form-control" placeholder="" value="">
                                        </div>
                                    </div>
                            </div>
                            <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">HUS Approval Status</label>
                                            <input type="text" id="BAOapproval" name="BAOapproval"  class="form-control" placeholder="" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                            class="control-label">HUS Approval Date</label>
                                            <input type="date" id="MCexceed" name="MCexceed" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">MC exceed 180 days</label>
