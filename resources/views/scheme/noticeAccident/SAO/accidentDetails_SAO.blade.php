...
<div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{url ('/noticeaccident')}}">
                        ...
                        <div class="form-body">
                            <h5 class="card-title">@lang('index.attr.details_accident')</h5>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <label class="control-label">Address Accident Place</label>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="addressaccident2" name="addressaccident2" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="addressaccident3" name="addressaccident3" value="" required>
                                    </div>
                                </div>
                            </div>
                            <div class='row'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="how" name="how" class="form-control" value=""></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label class="control-label">@lang('accidentDetails.attr.company_code')</label>
                                            <select name="industcode" class="form-control">
                                                <!--option value="">@if(!empty($accinfo)){{$accinfo->companycode}} @endif</option-->
                                                <option>Please select</option>
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label class="control-label">@lang('accidentDetails.attr.job_code')</label>
                                            <select name="profcode" class="form-control">
                                            <!--option value="">@if(!empty($accinfo)){{$accinfo->jobcode}} @endif</option-->
                                            <option>Please select</option>
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="reason" name="reason" class="form-control" placeholder=""></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">@lang('accidentDetails.attr.injury_desc')</label>
                                            <textarea type="text" id="injurydesc"  name="injurydesc" class="form-control" placeholder=""></textarea>
                                        </div>
                                    </div>
                                </div>
                            <!--/row-->
                            ...
                            <div class="row">    
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                                        data-autoclose="true">
                                            <input type="time" class="form-control" name="startworkingtime" value="">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                                    data-autoclose="true">
                                    <input type="time" class="form-control" name="restperiod" value="">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker" data-placement="bottom" data-align="top"
                                data-autoclose="true">
                                <input type="time" class="form-control" name="endworkingtime" value="">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" id="witnessname" name="witnessname" class="form-control" placeholder="" value="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">@lang('accidentDetails.attr.witness_no')</label>
                            <input type="text" id="witnesscontact" name="witnesscontact"  class="form-control" placeholder="" value="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" id="clinicinfo" name="clinicinfo" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                {{-- <button data-toggle="tab" href="#bankinfo" role="tab" class="btn waves-effect waves-light btn-info" id="btn-nextMc">
                @lang('insuredPerson.next')</button> --}}
                <button type="submit" class="btn btn waves-effect waves-light btn-success"> 
                @lang('insuredPerson.save')</button>
                {{-- <button data-toggle="tab" href="#wages" role="tab" class="btn waves-effect waves-light btn-info" id="btn-previousWages">
