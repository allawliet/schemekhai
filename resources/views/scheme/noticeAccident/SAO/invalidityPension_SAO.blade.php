        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="p-20">
                            <form action="#">
                                    <h3 class="card-title">@lang('invalidityPension.title')</h3>
                                    <hr>
                                    <div class="row p-t-20">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                               <label class="control-label">@lang('invalidityPension.attr.payment_hist')</label>
                                         ...
                                         <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('invalidityPension.attr.els')</label>
                                                <input type="text" name="els" id="els" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('invalidityPension.attr.notice_date')</label>
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                               <label class="control-label">@lang('invalidityPension.attr.debtor')</label>
