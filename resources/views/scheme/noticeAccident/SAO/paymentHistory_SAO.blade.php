<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <form action="#">
                    <h5 class="card-title">@lang('paymentHistory.title')</h5>
                    <hr>
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.mc_end')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.total_day')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.total_HUS')</label>
                       ...
                       <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.remark')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label class="control-label">@lang('paymentHistory.attr.status')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.assumed_wage')</label>
                       ...
                       <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.total_assumed')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label class="control-label">@lang('paymentHistory.attr.assumed_average_monthly')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.assumed_average_daily')</label>
                        ...
                        <div class="row p-t-20">
                             <div class="col-md-4">
                                 <div class="form-group">
                                     <label class="control-label">@lang('paymentHistory.attr.fhus_daily_rate')</label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="control-label">@lang('paymentHistory.attr.minimum_daily_rate')</label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group">
                                     <label class="control-label">@lang('paymentHistory.attr.maximum_daily_rate')</label>
                         ...
                         <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('paymentHistory.attr.total_HUS_days')</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       <label class="control-label">@lang('paymentHistory.attr.total_FHUS_payment')</label>
