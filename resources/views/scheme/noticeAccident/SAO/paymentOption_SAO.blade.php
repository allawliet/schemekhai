<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <form action="#">
                    <h5 class="card-title">@lang('paymentOption.title')</h5>
                    <hr>
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentOption.attr.huk_payment_option')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentOption.attr.date_payment_option')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentOption.attr.updatedby')</label>
                       ...
                       <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentOption.attr.updated_date')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label class="control-label">@lang('paymentOption.attr.approvedby')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('paymentOption.attr.approved_date')</label>
