                    ...
                    <form method="post" action="{{url ('/accidentDetails_sco')}}">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('accidentDetails.attr.accident_date')</label><span class="required">*</span>
                                        @if (!empty($accinfo))
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('accidentDetails.attr.time_accident')</label><span class="required">*</span>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('accidentDetails.attr.place_accident')</label><span class="required">*</span>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('accidentDetails.attr.when_accident')</label><span class="required">*</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('accidentDetails.attr.how_accident')</label><span class="required">*</span>
                                ...
                                <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.add_acc_place')</label><span class="required">*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.how_accident')</label><span class="required">*</span>
                                                <textarea type="text" id="how" name="how" class="form-control" value="" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            <div class="col-md-12 col-lg-4">
                                                <div class="form-group">
                                                    <label>@lang('accidentDetails.attr.mode_transport')</label><span class="required">*</span>
                                                    <select id="transport" name="transport" class="form-control">
                                                        <!--option value="">@if(!empty($accinfo)){{$accinfo->transport}} @endif</option-->
                                            ...
                                            <div class="col-md-12 col-lg-4">
                                                <div class="form-group">
                                                    <label>@lang('accidentDetails.attr.modeTransport_others')</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.causeOfAccd')</label><span class="required">*</span>
                                                <input name="causeOfAccd" id="causeOfAccd" type="text" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-12  col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.causative_agent')</label><span class="required">*</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12  col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.typeInjury')</label><span class="required">*</span>
                                                <select name="causative_agent" class="form-control">
                                                    <!--option value="">@if(!empty($accinfo)){{$accinfo->accdcode}} @endif</option-->
                                                    <option>@lang('accidentDetails.choose2')</option>
                                                    {{-- @foreach($accdcode as $c)
                                        ...
                                        <div class="col-md-12  col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.locationOfInjury')</label><span class="required">*</span>
                                                <select name="causative_agent" class="form-control">
                                                    <!--option value="">@if(!empty($accinfo)){{$accinfo->accdcode}} @endif</option-->
                                                    <option>@lang('accidentDetails.choose2')</option>
                                                    {{-- @foreach($accdcode as $c)
                                        ...
                                        <div class="col-md-12  col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('accidentDetails.attr.accident_code')</label><span class="required">*</span>
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">@lang('accidentDetails.attr.reason_travelling')</label><span class="required">*</span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">@lang('accidentDetails.attr.injury_desc')</label><span class="required">*</span>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>@lang('accidentDetails.attr.accident_workingDay')</label><span class="required">*</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label
                                        class="control-label">@lang('accidentDetails.attr.nameAddress_clinic')</label><span class="required">*</span>
