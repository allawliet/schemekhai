        ...
        <form method="post" action="{{url ('/updmc')}}">
            ...
            <div class="form-body ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">@lang('medicalDetails.attr.nameAddress_clinic')</label><span class="required">*</span>
                ...
                <div class="col-md-12" id="container">
                    <div class="table-responsive" id="table-medical">
                        <div class="form-actions text-right">
                            <button type="button" id="btn_add_mc0" value='0' class="btn btn-sm waves-effect waves-light btn-info">@lang('medicalDetails.addMc')</button>
                        ...
                        <table  id="table-medical-details0" class="table table-sm table-bordered" data-toggle-column="first">
                            <thead>
                                <tr>
                                    <th style='width:15%'>@lang('medicalDetails.attr.type_hus')</th> 
                                    <th style='width:15%'>@lang('medicalDetails.attr.HUS_recommendation')</th>
									<th style='width:8%'>@lang('medicalDetails.attr.recommendation_date')</th>  	
                                    <th style='width:17%'>@lang('medicalDetails.attr.start_date')</th>
                                    <th style='width:18%'>@lang('medicalDetails.attr.end_date')</th>
                                    <th style='width:10%'>@lang('medicalDetails.attr.days_work')</th>
                                    <th style='width:15%'>@lang('medicalDetails.attr.action')</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr data-expanded="true" class="workrow" id="tr0_0">
									...
									<td>
										<div class="form-group">
											<select class="form-control" name="hussts[]">
											<option>@lang('medicalDetails.choose2')</option>
											<option value="" selected>Approved</option>
											<option value="" selected>Rejected</option>
											<option value="" selected>Pending</option>
											<option value="" selected>Attended Work And Salary Paid During MC </option>
											<option value="" selected>Overlapped</option>
											<option value="" selected>Overlapped - Approved</option>
											<option value="" selected>Overlapped - Rejected</option>
											</select>
										</div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
                                            <input id="recommendationdate" name="recommendationdate" type="date" value="" class="form-control counttotalmc" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
				...
				<div class="col-md-12">
					...
					<label for="minimal-checkbox-disabled-checked">@lang('medicalDetails.attr.mc_exceed')</label>
				</div>
            </div>
            <div class="form-actions text-right">
                <button type="submit" name="action" value="Submit" class="btn btn-sm waves-effect waves-light btn-success btn-newMC" id='btnsubmit' onclick="mcsubmit()">@lang('insuredPerson.save')</button>
            ...
            $('button[id=add_attended_work'+i+'_'+j+']').click(function(){ 
                ...
                for (w = 0; w <= k; w++) { 
                    if($("#tr"+i+"_"+j+"_"+w).length == 0) { 
                        ...
                        $('#tr'+i+'_'+j).after('<tr id="tr'+i+'_'+j+'_'+w+'"><td><div class="col-md-12"> <input  name="attendedwork" type="text" value="Attended Work" class="form-control counttotalwork" readonly></div></td><td>'+
										'<div class="form-group">'+
											'<select class="form-control" name="hussts[]">'+
											'<option>@lang("medicalDetails.choose2")</option>'+
											'<option value="" selected>Approved</option>'+
