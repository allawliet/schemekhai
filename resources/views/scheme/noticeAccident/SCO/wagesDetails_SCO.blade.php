                ...
                <form action="#">
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('wages.attr.similarWorker')</label>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('wages.attr.commencement_date')</label><span class="required">*</span>
                                        ...
                                        <table id="demo-foo-row-toggler" class="table table-bordered"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style='width:5%' class="text-center">@lang('wages.attr.reject')</th>
                                                </tr>
                                            </thead>
                                            <tbody>
