    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="p-20">
                    <form action="#">
                        <h5 class="card-title">@lang('inconsistentInformation.title')</h5>
                        <hr>
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('inconsistentInformation.attr.item')</label>
                                    <input type="text" name="item" id="item" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                        <label class="control-label">@lang('inconsistentInformation.attr.data')</label>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('inconsistentInformation.attr.review')</label>
                                    <input type="text" name="review" id="review" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('inconsistentInformation.attr.review_by')</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3>@lang('inconsistentInformation.attr.justification_finding')</h3>
                                <hr>
                                    <div class="row p-t-20">    
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label">@lang('inconsistentInformation.attr.date_investigation')</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label">@lang('inconsistentInformation.attr.finding_data')</label>
                                        ...
                                        <div  class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">@lang('inconsistentInformation.attr.justification_finding')</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('inconsistentInformation.attr.justify_by')</label>
