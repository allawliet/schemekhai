                        ...
                        <div class="row p-t-20">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="text" name="list_task" id="list_task" class="form-control"></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="row p-t-20">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="text" name="rev_comment" id="rev_comment" class="form-control"></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="row p-t-20">
