            ...
            <div class="card-body">
                ...
                <form action="/caseinfo_revision" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <h5 class="card-title">Download Document</h5>
                            <table class="table">
                                <col width="50%">
                                <col width="10%">
                        ...
                        <hr>
                        <h5 class="card-title"> INSPECTOR INFORMATION </h5>
                        <hr>
                        ...
                        <h5 class="card-title"> INTERVIEWEE INFORMATION </h5>
                        <hr>
                        ...
                        <h5 class="card-title"> WITNESS INFORMATION </h5>
                        <hr>
