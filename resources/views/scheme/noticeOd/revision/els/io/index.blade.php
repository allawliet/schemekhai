...
<div class="col-md-12">
        ...
        <div class="tab-content tabcontent-border">
            <div class="tab-pane p-20 active" id="case_info" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.case_info')
            </div>
            <div class="tab-pane p-20" id="applicant" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.applicant_info')
            </div>
            <div class="tab-pane p-20" id="case_info2" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.case_info2')
            </div>
            <div class="tab-pane p-20" id="medical" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.medical_board')
            </div>
            <div class="tab-pane p-20" id="appointment" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.appointment')
            </div>
            ...
            <div class="tab-pane p-20" id="caseFact" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.caseFact')
            </div>
            ...
            <div class="tab-pane p-20" id="io_rec" role="tabpanel">
                @include('scheme.noticeOd.revision.els.io.io_recommendation')
            </div>
        </div>
    </div>
</div>
