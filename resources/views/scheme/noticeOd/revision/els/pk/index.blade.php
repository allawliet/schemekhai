...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h3 class="card-title">@lang('index.attr.els')</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tabcontent-border">
                            ...
                            <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                                @include('Scheme.revision.els.PK.remarks')
                            </div>
                            ...
                            <div class="tab-pane p-20" id="claimDetails" role="tabpanel">
                                ...
                                <div id="accordion2" role="tablist" class="accordion">
                                    ...
                                    <div class="card m-b-0">
                                        <div class="card-header" role="tab" id="caseInfo_els">
                                            <h5 class="mb-0">
                                                <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                                    href="#case_info" aria-expanded="false"
                                        ...
                                        <div id="case_info" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.els.PK.case_info')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        <div class="card-header" role="tab" id="applicantInfo_els">
                                            <h5 class="mb-0">
                                                <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                                    href="#applicant_info" aria-expanded="false"
                                                    aria-controls="collapseOne1">
                                                    <h4 class="card-title"><i class="fa fa-plus"></i>
                                                        @lang('index.attr.applicant')</h4>
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="applicant_info" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.els.PK.applicant_info')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        <div class="card-header" role="tab" id="caseInfo2_els">
                                            <h5 class="mb-0">
                                                <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                                    href="#caseInfo2" aria-expanded="false"
                                                    aria-controls="collapseOne1">
                                                    <h4 class="card-title"><i class="fa fa-plus"></i>
                                                        @lang('index.attr.caseInfo2')</h4>
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="caseInfo2" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.els.PK.case_info2')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        <div class="card-header" role="tab" id="medicalboard_els">
                                            <h5 class="mb-0">
                                                <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                                    href="#medicalboard" aria-expanded="false"
                                                    aria-controls="collapseOne1">
                                                    <h4 class="card-title"><i class="fa fa-plus"></i>
                                                        @lang('index.attr.medicalboard')</h4>
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="medicalboard" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.els.PK.medical_board')
                                            </div>
                                        </div>
                                    </div>
                                </div>
