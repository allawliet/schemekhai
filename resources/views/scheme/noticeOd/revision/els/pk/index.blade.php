...
<div class="col-md-12">
        ...
        <div class="tab-content tabcontent-border">
            <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                @include('scheme.noticeOd.revision.els.pk.remarks')
            </div>
            <div class="tab-pane p-20" id="claim" role="tabpanel">
                @include('scheme.noticeOd.revision.els.pk.claim')
            </div>
            <div class="tab-pane p-20" id="supporting" role="tabpanel">
                @include('scheme.noticeOd.revision.els.pk.supporting_document')
            </div>
        </div>
